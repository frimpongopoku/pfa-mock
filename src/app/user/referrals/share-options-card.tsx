...
const ShareButton: React.FC<{
  ...
  return (
    <motion.button
      ...
      className="flex items-center justify-center gap-2 rounded-md h-11 px-4 bg-slate-100 text-slate-700 text-sm font-medium hover:bg-slate-200 transition-colors w-full"
